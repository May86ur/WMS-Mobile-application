// ignore_for_file: prefer_const_constructors, non_constant_identifier_names, unused_catch_stack, unnecessary_null_comparison
...
class Graphical_Screen_Updated extends StatefulWidget {
  Graphical_Screen_Updated(
      {Key? key,
      AreaModel? area_,
  ...
  @override
  State<Graphical_Screen_Updated> createState() =>
      _Graphical_Screen_UpdatedState();
}

class _Graphical_Screen_UpdatedState extends State<Graphical_Screen_Updated> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
            title: Text(
              "Graphical OMS Details".toUpperCase(),
              textScaleFactor: 1,
              style: TextStyle(
  ...
  Widget getBody() {
    if (projectName!.toLowerCase().contains('hanuman')) {
      return GetPFCMDforSql();
    } else {
      return GetPFCMDforMysql();
    }
  }

  Widget GetPFCMDforMysql() {
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              child: Text(
                                "P1 : \n" +
                                    (convertBartoMeter(_DisplayList![index]
                                                        .controllertype ==
                                                    'BOC'
                                                ? _DisplayList![index].aI1
                              ...
                              child: Text(
                                "P2 : \n" +
                                    (convertBartoMeter(_DisplayList![index]
                                                        .controllertype ==
                                                    'BOC'
                                                ? _DisplayList![index].aI2
                                                : _DisplayList![index].aI3) ??
                                            0.0)
                                        .toString() +
                                    "m",
                                textScaleFactor: 1,
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            for (var i = 1;
                                i <= _DisplayList![index].subChakQty!;
                                i++)
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            ...
                            textScaleFactor: 1,
                            style: TextStyle(
                              color: (_DisplayList![index].oNLINE != 0
                                  ? Colors.green
                                  : Colors.red),
                              fontSize: getFontSize(
                                15,
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              '',
                                              // getRomsMode(_DisplayList![index].romsMode ?? 0),
...
*/
  ...
  getPTVALVEx(OmsMasterModel model, int x) {
    dynamic value = 0.0;
    switch (x) {
      case 1:
  ...
  getFlowVALVEx(OmsMasterModel model, int x) {
    dynamic value = 0.0;
    switch (x) {
      case 1:
  ...
  PFCMD_Details(OmsMasterModel model, int index) {
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Padding(
                                    ...
                                    child: Text(
                                      (model.availableResidualHead ?? 0.00)
                                              .toStringAsFixed(2) +
                                          " m",
                                      softWrap: true,
                                      textScaleFactor: 1,
  ...
  getinletpress(OmsMasterModel model, int x) {
    double value = 0.0;
    switch (x) {
      case 1:
  ...
  getvolume(OmsMasterModel model, int x) {
    dynamic value = 0.0;
    switch (x) {
      case 1:
  ...
  getpossetpoint(OmsMasterModel model, int x) {
    dynamic value = 0.0;
    switch (x) {
      case 1:
  ...
  getsuspress(OmsMasterModel model, int x) {
    dynamic value = 0.0;
    switch (x) {
      case 1:
  ...
  getredpress(OmsMasterModel model, int x) {
    dynamic value = 0.0;
    switch (x) {
      case 1:
  ...
  getflowsetpoint(OmsMasterModel model, int x) {
    dynamic value = 0.0;
    switch (x) {
      case 1:
  ...
  getactualflow(OmsMasterModel model, int x) {
    dynamic value = 0.0;
    switch (x) {
      case 1:
        value = model.flowValve1;
  ...
  getpos(OmsMasterModel model, int x) {
    dynamic value = 0.0;
    switch (x) {
      case 1:
  ...
  getirriagtionstatus(OmsMasterModel model, int x) {
    dynamic value = "";
    switch (x) {
      case 1:
