// ignore_for_file: non_constant_identifier_names, must_be_immutable, unused_local_variable, unused_catch_stack
import 'dart:convert';
...
import 'package:WMS_Application/Screens/Login/progressIndicator.dart';
...
class Oms_Screen_Updated extends StatefulWidget {
  String? ProjectName;

  Oms_Screen_Updated(String project) {
    ProjectName = project;
  }
  @override
  State<Oms_Screen_Updated> createState() => _Oms_Screen_UpdatedState();
}

class _Oms_Screen_UpdatedState extends State<Oms_Screen_Updated> {
  get status => null;
    ...
    try {
      if (BatLevel == 0) {
        ...
        if (BatType == 1) {
          ...
          // if (constring.toString().contains('dba')) {
              ...
              child: InkWell(
                  onTap: () {
                    Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => OMS_Details_Screen(
                          ...
                          child: Stack(
                            children: [
                              ...
                              Positioned(
                                ...
                                left: 20,
                                child: Text(
                                    (_DisplayList![index].batteryLevel1! < 0
                                                ? 0
                                                : _DisplayList![index]
                                                    .batteryLevel1!)
                                            .toStringAsFixed(1) +
