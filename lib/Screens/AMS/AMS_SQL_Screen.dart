...
import 'package:WMS_Application/Screens/AMS/AMS_DetailView_Sql.dart';
import 'package:WMS_Application/Screens/AMS/AMS_Trend_Screen.dart';
import 'package:WMS_Application/Screens/AMS/AMS_Trend_Screen_SQL.dart';
...
class Ams_SQL_screen extends StatefulWidget {
  late final String? ProjectName;
  var AreaId;

  Ams_SQL_screen(String project, {var areaId = 0}) {
    ProjectName = project;
    AreaId = areaId;
  }
  @override
  State<Ams_SQL_screen> createState() => _Ams_SQL_screenState();
}

class _Ams_SQL_screenState extends State<Ams_SQL_screen> {
  get status => null;
    ...
    return Container(
      ...
      child: DropdownButton(
        ...
        onChanged: (textvalue) async {
          ...
          // setState(() {
          //   try {
          //     selectedState = textvalue as AreaModel;_firstLoad
          //   } catch (_, ex) {
          //     print(ex);
          //   }
          // });
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => AMSTrendScreenSql(
                                            area_: selectedArea ??
                                                new AreaModel(
                                                    areaid: 0,
  ...
  //       return 0.0;
  //     } else {
  //       batper = ((BatLevel - 11.1) * 100) / (16.8 - 11.1);
  //       // var BatLvl = ((replaceNull(v.BatteryLevel, '-') - 11.1) * 100 / (16.8 - 11.1))
  //       if (batper <= 0.0)
  //         batper = 0.0;
  //       else if (batper >= 100.00) batper = 100.00;
  //       return batper;
              ...
              child: InkWell(
                  onTap: () {
                    Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => AmsDetailViewSql(
                                    item, widget.ProjectName!)))
                        .whenComplete(() async {
                      setState(() {
                        _page = 0;
                      });
                  ...
                  child: Row(
                    ...
                    children: [
                        ...
                        child: Center(
                          child: Stack(children: [
                            Center(
                              ...
                              onTap: () {
                                _DisplayList![index].alarmCount != 0
                                    ? showDialog(
                                        context: context,
                      ...
                      Container(
                        width: 80,
                        child: Center(
                          child: _DisplayList![index].lastResponseTime1 !=
                                      null &&
                                  _DisplayList![index]
                                          .lastResponseTime1!
                                          .length >
                                      0
                              ? Text(getshortdate(_DisplayList![index]
                                  .lastResponseTime1!)) /*
                              (_DisplayList![index].lastResponseTime!.length >=
                                      19
                                  ? Text(
                                      _DisplayList![index]
                                              .lastResponseTime1!
