...
import 'package:WMS_Application/Model/Project/amsCountModel.dart';
import 'package:WMS_Application/Screens/AMS/AMS_DetailView.dart';
import 'package:WMS_Application/Screens/AMS/AMS_Trend_Screen.dart';
...
class AmsOvervire_screen extends StatefulWidget {
  late final String? ProjectName;

  AmsOvervire_screen(String project) {
    ProjectName = project;
  }
  @override
  State<AmsOvervire_screen> createState() => _AmsOvervire_screenState();
}

class _AmsOvervire_screenState extends State<AmsOvervire_screen> {
  get status => null;
  ...
  int TotalAms = 0, OnlineAms = 0, OfflineAms = 0, DamageAms = 0;
  ...
  // List<AMSMasterModel>? _OmsList;
  List<AMSMasterModel>? _DisplayList = <AMSMasterModel>[];
  ...
  void initState() {
    super.initState();
    getDropDownAsync().whenComplete(() async => await GetAmsOverviewModel());
    setState(() {
      _DisplayList = [];
    });
    _firstLoad();
  ...
  Future<List<Ams_Overview_Model>>? AmsListFuture;
  List<Ams_Overview_Model>? AmsOverviewList = [];
  Future<List<AMSMasterModel>>? DisplayListFuture;

  Future GetAmsOverviewModel() async {
    try {
      setState(() {
        AmsListFuture = getAmsOverviewdata(AMSStatusCheck!, DamageStatusCheck!,
            area.toString(), distibutory.toString());
        AmsListFuture!.then((value) {
          setState(() {
            AmsOverviewList = value;
          });
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: AppBar(
          title: Text(
            widget.ProjectName!.toString().toUpperCase() + "- AMS",
            textScaleFactor: 1,
            // "Kundalia_LBC-OMS",
            style: TextStyle(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => AMSTrendScreen(
                                            area_: selectedArea ??
                                                new AreaModel(
                                                    areaid: 0,
                                            ...
                                            AmsStatus_Check_: AMSStatusCheck,
                                            DamageStatus_check_:
                                                DamageStatusCheck,
                                            ListStatus_:
                                        ...
                                        onTap: () async {
                                          ...
                                          setState(() {
                                            if ((cheklist
                                              ...
                                              cheklist = ['All'];
                                              AmsOverviewList!.forEach((element) {
                                                element.isChecked = false;
                                              });
                                            }
                                            //PopupModelList = items;
                                          });
                                          var items = AmsOverviewList!
                                              .where((element) => !(element
                                                  .subProcess!
                                                  .contains('AMS STATUS')))
                                              .toList();
                                          Set<String> SubProcesses =
                                              new Set<String>();
                                          items.forEach((x) =>
                                              SubProcesses.add(x.subProcess!));
                                          await showDialog(
                                              context: context,
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                GridView.count(
                                                                                  ...
                                                                                  mainAxisSpacing: 5.0,
                                                                                  children: [
                                                                                    for (var item in AmsOverviewList!.where((element) => element.subProcess == pr).toList())
                                                                                      Column(
                                                                                        children: [
                                                                                          Checkbox(
                                                              ...
                                                              children: [
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    setState(() {
                                                                      ...
                                                                      if (AmsOverviewList!
                                                                              ...
                                                                              .length !=
                                                                          0) {
                                                                        cheklist = AmsOverviewList!
                                                                            .where((element) =>
                                                                                element.isChecked ==
                                                                                true)
                                                                            .select((element, index) => element
                                                                                .dESCRIPTION!
                                                                                .toString())
                                                                            .toList();
                                                                      } else {
                                                                ...
                                                                ElevatedButton(
                                                                  onPressed:
                                                                    ...
                                                                    for (String pr
                                                                        in SubProcesses)
                                                                      for (var item in AmsOverviewList!
                                                                          .where((element) =>
                                                                              element.subProcess ==
                                                                              pr)
                                                                          .toList())
  ...
  Future<void> showFilterPopup(context) async {
    setState(() {
      if ((cheklist.where((element) => element == 'All').length == 0) &&
        ...
        cheklist.forEach((element) {
          AmsOverviewList!
              .where((item) => item.dESCRIPTION == element)
              .first
              .isChecked = true;
        });
      else {
    ...
    var items = AmsOverviewList!
        .where((element) => !(element.subProcess!.contains('AMS STATUS')))
        .toList();
  ...
  SetTotalStatusCount(List<Ams_Overview_Model> list) {
    list
        .where((element) => element.subProcess!.contains('AMS STATUS'))
        .forEach((element) {
      setState(() {
        if (element.dESCRIPTION!.contains('TotalAms'))
          TotalAms = element.vALUE!;
        if (element.dESCRIPTION!.contains('OnlineAms'))
          OnlineAms = element.vALUE!;
        if (element.dESCRIPTION!.contains('OfflineAms'))
          OfflineAms = element.vALUE!;
        if (element.dESCRIPTION!.contains('DamageAms'))
          DamageAms = element.vALUE!;
      });
    });
  }

  /* getName(String description) {
    if (description == 'DOOR_OPEN') {
      return 'DOOR OPEN';
    } else if (description == 'LOW_BATTERY') {
      return 'LOW BATTERY';
    } else if (description == 'LOW_SOLAR') {
      return 'LOW SOLAR';
    } else if (description == 'LOW_FLOW') {
      return 'LOW FLOW';
    } else if (description == 'HIGH_FLOW') {
      return 'HIGH FLOW';
    } else if (description == 'NO_FLOW') {
      return 'NO FLOW';
    } else if (description == 'LOW_PRESSURE') {
      return 'LOW PRESSURE';
    } else if (description == 'HIGH_PRESSURE') {
      return 'HIGH PRESSURE';
    } else if (description == 'IN_IRRIGATION') {
      return 'IN IRRIGATION';
    } else if (description == 'VOLUME_PASSED') {
      return 'VOLUME PASSED';
    } else if (description == 'ONOFF_MODE') {
      return 'ONOFF';
    } else if (description == 'FLOW_CONTROL_MODE') {
      return 'FLOW CONTROL';
    } else if (description == 'POSITION_CONTROL_MODE') {
      return 'POSITION CONTROL';
    } else if (description == 'OTHER_MODE') {
      return 'OTHER';
    } else if (description == 'MANUAL_MODE') {
      return 'MANUAL';
    } else if (description == 'AUTO_MODE') {
      return 'AUTO';
    } else if (description == 'TESTING_MODE') {
      return 'TESTING';
    } else if (description == 'ROMS_OTHER_MODE') {
      return 'ROMS OTHER';
    } else if (description == 'SOLAR_PANEL') {
      return 'SOLAR PANEL';
    } else if (description == 'WRF_ANTENNA') {
      return 'WRF ANTENNA';
    } else if (description == 'SOLAR_CABLE') {
      return 'SOLAR CABLE';
    } else if (description == 'BATTERY') {
      return 'BATTERY';
    } else if (description == 'OMS_PCB') {
      return 'OMS PCB';
    } else if (description == 'WITH_SCHEDULE') {
      return 'WITH SCHEDULE';
    } else if (description == 'WITHOUT_SCHEDULE') {
...
*/
  String getBattreydata(double LevelStatus) {
    try {
      ...
      } else if (LevelStatus < 60 && LevelStatus >= 50) {
        return "assets/images/battery55.png";
      } else if (LevelStatus < 50 && LevelStatus >= 40) {
        return "assets/images/battery39.png";
  ...
  getBatpercentage(double BatLevel) {
    var batper;
    try {
      return (BatLevel < 0.0) ? 0.0 : BatLevel;
      /*if (BatLevel == 0) {
        return 0.0;
      } else {
  ...
  getAmsList(BuildContext context) {
    return Expanded(
      child: Scrollbar(
              ...
              child: InkWell(
                  onTap: () {
                    Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    AmsDetailView(item, widget.ProjectName!)))
                        .whenComplete(() async {
                      setState(() {
                        _page = 0;
                      });
                                ...
                                child: Image(
                                  image: AssetImage(getBattreydata(
                                      getBatpercentage(_DisplayList![index]
                                                  .batteryLevel1 !=
                                              null
                                          ? _DisplayList![index].batteryLevel1!
                                          : 0.0))),
                                  width: 30,
                                  height: 30,
                                ),
  ...
  void _firstLoad() async {
    ...
    try {
      ...
      final res = await http.get(Uri.parse(
          'http://wmsservices.seprojects.in/api/AMS/AMSDisplayList?Search=$_search&_aid=$area&_did=$distibutory&_AMSStatus=$AMSStatusCheck&_DamageStatus=$DamageStatusCheck&_ListStatus=$liststatus&pageIndex=$_page&pageSize=$_limit&conString=$conString'));
  ...
  void _loadMore() async {
    if (_hasNextPage == true &&
      ...
      try {
        ...
        final res = await http.get(Uri.parse(
            'http://wmsservices.seprojects.in/api/AMS/AMSDisplayList?Search=$_search&_aid=$area&_did=$distibutory&_AMSStatus=$AMSStatusCheck&_DamageStatus=$DamageStatusCheck&_ListStatus=$liststatus&pageIndex=$_page&pageSize=$_limit&conString=$conString '
            // 'http://wmsservices.seprojects.in/api/Project/OMSDisplayList?Search=$_search&_aid=$area&_did=$distibutory&_OMSStatus=$AMSStatusCheck&_DamageStatus=$DamageStatusCheck&_ListStatus=$liststatus&pageIndex=$_page&pageSize=$_limit&conString=$conString'
            ));
        var json = jsonDecode(res.body);
        List<AMSMasterModel> fetchedData = <AMSMasterModel>[];
        json.forEach((e) => fetchedData.add(new AMSMasterModel.fromJson(e)));
  ...
  Future<void> getScount() async {
    try {
      ...
      final response = await http.get(Uri.parse(
          'http://wmsservices.seprojects.in/api/AMS/AMSDisplayListCount?Search=$_search&_aid=$area&_did=$distibutory&_AMSStatus=$AMSStatusCheck&_DamageStatus=$DamageStatusCheck&_ListStatus=$liststatus&conString=$conString'));

      if (response.statusCode == 200) {
        var json = jsonDecode(response.body);
        List<amsCountModel> Result = <amsCountModel>[];
        json.forEach((v) => Result.add(new amsCountModel.fromJson(v)));
        setState(() {
